...
class FakeTextElement implements TextElement {
  ...
  TextMeasurement get measurement =>
      TextMeasurement(horizontalSliceWidth: text.length.toDouble(), verticalSliceWidth: textStyle.fontSize.toDouble(), baseline: textStyle.fontSize.toDouble());
}

class MockLinePaint extends Mock implements LineStyle {}

class FakeBarRendererElement extends Fake implements ImmutableBarRendererElement<String> {
...
void main() {
  ...
  setUpAll(() {
    ...
    registerFallbackValue(FakeTextElement('text'));
  });
